...
date: 2024-08-22
updated: 2024-09-10T13:58:00.000Z
tags:
  - postgres
  - databases
socials:
  - https://news.ycombinator.com/item?id=41319025
  - https://lobste.rs/s/3hrvyp/how_postgres_stores_oversized_values_let
  - https://www.linkedin.com/posts/drewsilcock_how-postgres-stores-oversized-values-lets-activity-7232347669128450048-lsWB?utm_source=share&utm_medium=member_desktop
  - https://x.com/drewlhsilcock/status/1826581993322389900
---

import { Image } from 'astro:assets';

import varlenaStructsDark from "../../assets/how-postgres-stores-oversized-values/varlena-structs-dark.png";
import varlenaStructsLight from "../../assets/how-postgres-stores-oversized-values/varlena-structs-light.png";
...
_**(If you've just come from [part 1](/blog/how-postgres-stores-data-on-disk) and still have the database setup, feel free to [skip over this bit](#lets-create-another-table).)**_
...
[^carefully-selected]: The smaller and bigger were easier but finding a poem of just the right length to be compressed but not out-of-lined was tricky – big shout out to that Grecian urn 🙏🏻⚱️
...
<Image class="image-dark" alt="Postgres variable length attribute (varlena) structures (dark mode)" src={varlenaStructsDark} />
<Image class="image-light" alt="Postgres variable length attribute (varlena) structures (light mode)" src={varlenaStructsLight} />
